...
| ID | Titel | Typ | Rolle | Prio | Sprint | blockiert durch |
|---|---|---|---|---|---|---|
| [T-0001](tickets/T-0001.md) | DR: G0 — Projektauftrag P4 „Mission Control 3.1: Fernzugriff & Briefkasten-Chat" freigeben | decision-request | pl | hoch | 0 | — |
| [T-0002](tickets/T-0002.md) | MAN.3: Sprint-0-Planning — Fundament (Anforderungen + ADR-006) | task | pl | hoch | 0 | — |
| [T-0003](tickets/T-0003.md) | SWE.1: STK-016 + SWR-048-052 (LAN/PIN, Briefkasten, Mobile) draft -> reviewed | task | rm | hoch | 0 | — |
